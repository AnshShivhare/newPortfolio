      ...
      <div className="about__container grid">
        ...
        <div className="about__data grid">
          <div className="about__info">
            <p className="about__description">I am Ansh Shivhare. I am Well-versed in Frontend Development (HTML, CSS, JavaScript, React.js, Node.js) along with that I am Strong at Data Structure & Algorithms, and Competitive Programming.<br/><br/>
            I am Passionate and Curious about Programming. I have Built many Full-stack Projects with the same technologies as well. </p>
            <a href="https://drive.google.com/file/d/1WeIOSK9mBfKBZdx8HF1UvCXF9hfJ0io1/view" className="btn">Download CV</a>
          </div>
